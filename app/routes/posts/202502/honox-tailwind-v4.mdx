...
このブログではスタイリングに <code className="bg-gray-200 text-gray-700 font-normal">Tailwind CSS</code> を使用しています。
<code className="bg-gray-200 text-gray-700 font-normal">HonoX</code> で 最新の v4 を使ったら少し嵌りました。
